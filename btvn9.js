...
//tim user co id thoa man dieu kien
// function findUserById(id) {
//     //dung for, for ... of, forEach
//     for (let user of users) {
//         if (user.id == id) return user;
//     }
//     return null;

//     // dung phuong thuc find cua mang
// }

//Đếm số lượng user có age > 50.
let result = users.filter(user => user.age > 50).length;
console.log(result);

//Đếm số lượng user đã kết hôn và chưa kết hôn.

let result1 = users.reduce((acc, user) => {
    ...
    return acc;
  }, { chua_ket_hon: 0, ket_hon: 0 });
  
  console.log(result1);
  
//Đếm số lượng user theo từng ngành nghề tương ứng.

let countByJob = users.reduce((accumulator, currentValue) => {
let { job } = currentValue;
    
    if (job in accumulator) {
      accumulator[job]++;
    } else {
      accumulator[job] = 1;
    }
